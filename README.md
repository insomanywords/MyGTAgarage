...
[![Version](https://img.shields.io/badge/version-1.66.2-blue.svg)](https://github.com/insomanywords/MyGTAgarage)
...
See the in-app **About > View Changelog** modal for a detailed history of updates and bug fixes, including the latest **v1.66.2** improvements.
